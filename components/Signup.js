        ...
        <>
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header " style={{backgroundColor:"#9ceaef"}}>
                            <h1 className="modal-title fs-5" id="exampleModalToggleLabel">Sign up</h1>
                        ...
                        <div className="modal-footer" style={{backgroundColor:"#9ceaef"}}>
                            ...
                            <button className="btn btn-primary" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal">sign in</button>
                        </div>
                    </div>
                </div>
            </div>
            <div className="modal fade" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header" style={{backgroundColor:"#9ceaef"}}>
                            <h1 className="modal-title fs-5" id="exampleModalToggleLabel2">Sign in</h1>
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div className="modal-body">
                            {/* form */}
                        ...
                        <div className="modal-footer " style={{backgroundColor:"#9ceaef"}}>
                            ...
                            <button className="btn btn-primary" data-bs-target="#exampleModalToggle" data-bs-toggle="modal">Sign up</button>
                        </div>
                    </div>
                </div>
            </div>
